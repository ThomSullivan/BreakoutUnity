...
public class BallSpawnerScript : MonoBehaviour
{
        ...
        //The SpawnBall method is a custom method, it spawns a ball into the game and applies velocity to it. 
    {
        ...
        clone.velocity = transform.TransformDirection(Vector2.up * (15*(Mathf.Log10(logic.level+1))+10));// Logarithmic function for increase in ball speed allows for non-linear growth of ball speed each level.
    }
}
